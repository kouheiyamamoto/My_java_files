...
public class ScoreAnalyzer1Method2 {
    ...
    void analyze(Integer n, BufferedReader in) throws IOException {
        ...
        while ((line = in.readLine()) != null) {
            Integer getScorePeople;
            getgetScorePeople(line, n, getScorePeople);
    ...
    void getgetScorePeople(String lin, Integer n, Integer count ){
    ...
    public static void main(String[] args) throws IOException {
        ScoreAnalyzer1Method2 step1 = new ScoreAnalyzer1Method2();
        step1.run(args);
    }
}