...
public class EZGraphicsTest {
    void run() throws InterruptedException {
        init();
        EZCircle circle1 = EZ.addCircle(125, 125, 40, 40, Color.RED, true); // (3)
        EZCircle circle2 = EZ.addCircle(125, 275, 40, 40, Color.RED, true); // (4)
    ...
    void animation(EZCircle circle1, EZCircle circle2) throws InterruptedException {
        Integer dx = 50;
        Integer dy = -50;
        while (true) {
            Thread.sleep(1000);
            ...
            EZ.refreshScreen();
            if (circle1.getYCenter() > 300 || circle1.getYCenter() < 100) {
                dy = dy * -1;
            }
            if (circle2.getXCenter() > 300 || circle2.getXCenter() < 100) {
                dx = dx * -1;
            }
        }
    }
