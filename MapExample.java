...
/**
 * 以下のプログラムを実行する時に，次のファイル（grades.csv）をコマンドライン引数で渡した時 に，次の問に答えよ．
 *
 * grades.csv ----------
 *
 * 010734,33 
 ...
 * 出力結果 -------
 *
 * 統計: 20, 94, average: 68.813 秀: 5 優: 8 不可: 9 良: 6 可: 4
 */
...
public class MapExample {
    ...
    void printResult(HashMap<String, Integer> map, Integer value1, Integer value2, Double value3) {
        System.out.printf("統計: %d, %d, average: %2.3f%n", value1, value2, value3);
