 ...
 * 小テスト：プログラム読解
 *
 * (1) この行で出力される日付を選択せよ（2017/4/20に実行したものとせよ）．
 * a. 2018-04-20
 * b. 2017-04-20
 * (2) この行で出力される日付を選択せよ（2017/4/20に実行したものとせよ）．
 * a. 2018-04-20
 * b. 2017-04-20
 * (3) この行で出力される日付を選択せよ（2017/4/20に実行したものとせよ）．
 * a. 2018-04-20
 * b. 2017-04-20
 * (4) この行で出力される日付を選択せよ（2017/4/20に実行したものとせよ）．
 * a. 2018-04-20
 * b. 2017-04-20
 * (5) この行で出力される日付を選択せよ（2017/4/20に実行したものとせよ）．
 * a. 2018-04-20
 * b. 2017-04-20
 */
...
public class Date{
    ...
    void printDate(Date date) {
        System.out.printf("%4d-%02d-%02d%n", date.getYear() + 1900, date.getMonth() + 1, date.getDate());
    }
